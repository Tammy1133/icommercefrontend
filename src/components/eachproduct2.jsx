...
export const EachProduct2 = (item) => {
  // console.log(item);
  ...
  return (
    <div className="hover:cursor-grab transition-all hover:scale-[103%] p-2 sm:p-3   w-[150px] min-[500px]:w-[200px]   min-[640px]:w-[280px] border-2 border-slate-200 mb-3">
      <div className="">
        <img
        ...
        <div className="mt-2  min-[640px]:text-left ">
          ...
          <div className="sm:flex-row   flex items-center ">
            ...
            >
              <h1 className="text-[10px] pt-[10px]">Add to cart</h1>
